/*
 * ScrollOfEnchantWeaponToHit.java: item object
 * 
...
public class ScrollOfEnchantWeaponToHit extends TreasureType {
	public ScrollOfEnchantWeaponToHit() {
		this.name = "Enchant Weapon To-Hit";
		this.flags = 0x1L;
