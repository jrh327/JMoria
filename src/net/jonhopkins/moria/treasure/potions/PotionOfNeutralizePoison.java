/*
 * PotionOfNeutralizePoison.java: item object
 * 
...
public class PotionOfNeutralizePoison extends TreasureType {
	public PotionOfNeutralizePoison() {
		this.name = "Neutralize Poison";
		this.flags = 0x1000L;
