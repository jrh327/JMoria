/*
 * PotionOfRestoreDexterity.java: item object
 * 
...
public class PotionOfRestoreDexterity extends TreasureType {
	public PotionOfRestoreDexterity() {
		this.name = "Restore Dexterity";
