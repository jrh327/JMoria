...
public class Sets {
	...
	public static boolean set_frost_destroy(InvenType item) {
		return item.tval == Constants.TV_POTION1 || item.tval == Constants.TV_POTION2 || item.tval == Constants.TV_FLASK;
	}
	...
	public static boolean set_lightning_destroy(InvenType item) {
		return item.tval == Constants.TV_RING || item.tval == Constants.TV_WAND || item.tval == Constants.TV_SPIKE;
	}
