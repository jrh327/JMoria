/*
 * DownStaircase.java: item object
 * 
...
public class DownStaircase extends TreasureType {
	public DownStaircase() {
		this.name = "a down staircase";
		this.flags = 0x00000000L;
		this.tval = Constants.TV_DOWN_STAIR;
		this.tchar = '>';
		this.p1 = 0;
		this.cost = 0;
		this.subval = 1;
