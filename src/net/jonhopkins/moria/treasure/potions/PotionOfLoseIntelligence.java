/*
 * PotionOfLoseIntelligence.java: item object
 * 
...
public class PotionOfLoseIntelligence extends TreasureType {
	public PotionOfLoseIntelligence() {
		this.name = "Lose Intelligence";
		this.flags = 0x10L;
