/*
 * ScrollOfEnchantWeaponToDam.java: item object
 * 
...
public class ScrollOfEnchantWeaponToDam extends TreasureType {
	public ScrollOfEnchantWeaponToDam() {
		this.name = "Enchant Weapon To-Dam";
		this.flags = 0x2L;
