/*
 * ScrollOfProtectionfromEvil.java: item object
 * 
...
public class ScrollOfProtectionfromEvil extends TreasureType {
	public ScrollOfProtectionfromEvil() {
		this.name = "Protection from Evil";
