/*
 * TheMagesGuideToPower.java: item object
 * 
...
public class TheMagesGuideToPower extends TreasureType {
	public TheMagesGuideToPower() {
		this.name = "[The Mages' Guide to Power]";
		this.flags = 0x7F000000L;
