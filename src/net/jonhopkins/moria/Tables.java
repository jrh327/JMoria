/*
 * Tables.java: store/attack/RNG/etc tables and variables
 * 
...
public class Tables {
	...
	public static final StoreOwnerType[] owners = {
		...
		new StoreOwnerType("Arndal Beast-Slayer    (Half-Elf)   Weaponsmith", 10000, 185, 110, 5, 1, 8),
		new StoreOwnerType("Hardblow the Humble    (Human)      Temple", 3500, 175, 109, 6, 0, 15),
		new StoreOwnerType("Ga-nat the Greedy      (Gnome)      Alchemist", 12000, 220, 115, 4, 4, 9),
		new StoreOwnerType("Valeria Starshine      (Elf)        Magic Shop", 32000, 175, 110, 5, 2, 11),
		new StoreOwnerType("Andy the Friendly      (Halfling)   General Store", 200, 170, 108, 5, 3, 15),
		new StoreOwnerType("Darg-Low the Grim      (Human)      Armory", 10000, 190, 111, 4, 0, 9),
		new StoreOwnerType("Oglign Dragon-Slayer   (Dwarf)      Weaponsmith", 32000, 195, 112, 4, 5, 8),
		new StoreOwnerType("Gunnar the Paladin     (Human)      Temple", 5000, 185, 110, 5, 0, 23),
		new StoreOwnerType("Mauser the Chemist     (Half-Elf)   Alchemist", 10000, 190, 111, 5, 1, 8),
		new StoreOwnerType("Gopher the Great!      (Gnome)      Magic Shop", 20000, 215, 113, 6, 4, 10),
		new StoreOwnerType("Lyar-el the Comely     (Elf)        General Store", 300, 165, 107, 6, 2, 18),
		new StoreOwnerType("Mauglim the Horrible   (Half-Orc)   Armory", 3000, 200, 113, 5, 6, 9),
		new StoreOwnerType("Ithyl-Mak the Beastly  (Half-Troll) Weaponsmith", 3000, 210, 115, 6, 7, 8),
		new StoreOwnerType("Delilah the Pure       (Half-Elf)   Temple", 25000, 180, 107, 6, 1, 20),
	...
	/* Do not move the first three */
		...
		"Purple Speckled", "Red", "Red Speckled", "Silver Speckled","Smoky", "Tangerine",
	...
	public static final String[] syllables = {
		...
		"bie",	"bin",	"bit",	"bjor",	"blu",	"bot",	"bu",	"byt",
		"comp",	"con",	"cos",	"cre",	"dalf",	"dan",	"den",	"doe",
		"dok",	"eep",	"el",	"eng",	"er",	"ere",	"erk",	"esh",
		"evs",	"fa",	"fid",	"for",	"fri",	"fu",	"gan",	"gar",
		"glen",	"gop",	"gre",	"ha",	"he",	"hyd",	"i",	"ing",
		"ion",	"ip",	"ish",	"it",	"ite",	"iv",	"jo",	"kho",
		"kli",	"klis",	"la",	"lech",	"man",	"mar",	"me",	"mi",
		"mic",	"mik",	"mon",	"mung",	"mur",	"nej",	"nelg",	"nep",
		"ner",	"nes",	"nis",	"nih",	"nin",	"o",	"od",	"ood",
		"org",	"orn",	"ox",	"oxy",	"pay",	"pet",	"ple",	"plu",
		"po",	"pot",	"prok",	"re",	"rea",	"rhov",	"ri",	"ro",
		"rog",	"rok",	"rol",	"sa",	"san",	"sat",	"see",	"sef",
		"seh",	"shu",	"ski",	"sna",	"sne",	"snik",	"sno",	"so",
		"sol",	"sri",	"sta",	"sun",	"ta",	"tab",	"tem",	"ther",
		"ti",	"tox",	"trol",	"tue",	"turs",	"u",	"ulk",	"um",
		"un",	"uni",	"ur",	"val",	"viv",	"vly",	"vom",	"wah",
		"wed",	"werg",	"wex",	"whon",	"wun",	"x",	"yerg",	"yp",
		"zun"
	};
