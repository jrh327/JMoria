/*
 * ChantsAndBlessings.java: item object
 * 
...
public class ChantsAndBlessings extends TreasureType {
	public ChantsAndBlessings() {
		this.name = "[Chants and Blessings]";
		this.flags = 0x1FF0000L;
