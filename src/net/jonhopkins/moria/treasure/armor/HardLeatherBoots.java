/*
 * HardLeatherBoots.java: item object
 * 
...
public class HardLeatherBoots extends TreasureType {
	public HardLeatherBoots() {
		this.name = "& Pair of Hard Leather Boots";
		this.flags = 0x00000000L;
		this.tval = Constants.TV_BOOTS;
		this.tchar = ']';
		this.p1 = 0;
		this.cost = 12;
		this.subval = 3;
