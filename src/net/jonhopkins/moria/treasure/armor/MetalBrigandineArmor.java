/*
 * MetalBrigandineArmor.java: item object
 * 
...
public class MetalBrigandineArmor extends TreasureType {
	public MetalBrigandineArmor() {
		this.name = "Metal Brigandine Armor";
