/*
 * PotionOfRestoreCharisma.java: item object
 * 
...
public class PotionOfRestoreCharisma extends TreasureType {
	public PotionOfRestoreCharisma() {
		this.name = "Restore Charisma";
		this.flags = 0x800L;
