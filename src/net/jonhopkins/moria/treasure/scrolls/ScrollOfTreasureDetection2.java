/*
 * ScrollOfTreasureDetection2.java: item object
 * 
...
public class ScrollOfTreasureDetection2 extends TreasureType {
	public ScrollOfTreasureDetection2() {
		this.name = "Treasure Detection";
		this.flags = 0x4000L;
