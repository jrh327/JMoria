/*
 * TwoHandedSwordZweihander.java: item object
 * 
...
public class TwoHandedSwordZweihander extends TreasureType {
	public TwoHandedSwordZweihander() {
		this.name = "& Two-Handed Sword (Zweihander)";
