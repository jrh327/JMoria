/*
 * PotionOfSlimeMoldJuice.java: item object
 * 
...
public class PotionOfSlimeMoldJuice extends TreasureType {
	public PotionOfSlimeMoldJuice() {
		this.name = "Slime Mold Juice";
		this.flags = 0x30000000L;
