/*
 * PotionOfCureLightWounds3.java: item object
 * 
...
public class PotionOfCureLightWounds3 extends TreasureType {
	public PotionOfCureLightWounds3() {
		this.name = "Cure Light Wounds";
		this.flags = 0x10001000L;
