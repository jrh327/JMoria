/*
 * TwoHandedSwordNoDachi.java: item object
 * 
...
public class TwoHandedSwordNoDachi extends TreasureType {
	public TwoHandedSwordNoDachi() {
		this.name = "& Two-Handed Sword (No-Dachi)";
