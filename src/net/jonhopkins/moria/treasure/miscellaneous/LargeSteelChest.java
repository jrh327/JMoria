/*
 * LargeSteelChest.java: item object
 * 
...
public class LargeSteelChest extends TreasureType {
	public LargeSteelChest() {
		this.name = "& Large Steel Chest";
		this.flags = 0x33800000L;
