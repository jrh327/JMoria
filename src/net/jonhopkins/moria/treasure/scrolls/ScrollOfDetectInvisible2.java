/*
 * ScrollOfDetectInvisible2.java: item object
 * 
...
public class ScrollOfDetectInvisible2 extends TreasureType {
	public ScrollOfDetectInvisible2() {
		this.name = "Detect Invisible";
		this.flags = 0x80000L;
