/*
 * SmallSteelChest.java: item object
 * 
...
public class SmallSteelChest extends TreasureType {
	public SmallSteelChest() {
		this.name = "& Small Steel Chest";
		this.flags = 0x1B800000L;
