/*
 * ScrollOfDoorStairLocation3.java: item object
 * 
...
public class ScrollOfDoorStairLocation3 extends TreasureType {
	public ScrollOfDoorStairLocation3() {
		this.name = "Door/Stair Location";
		this.flags = 0x20000L;
