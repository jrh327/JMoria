	...
	public static void addMagicToTreasure(int x, int level) {
			...
			if (Misc1.isMagik(chance)) {
				...
				if (Misc1.isMagik(3 * special / 2)) {
					...
					case 2:	/* Defender	 */
						...
						t_ptr.tohit += 3;
						t_ptr.plusToDam += 3;
						t_ptr.plusToArmorClass += 5 + Rnd.randomInt(5);
			...
			if (Misc1.isMagik(chance)) {
				...
				if (Misc1.isMagik(special)) {
					if (Rnd.randomInt(2) == 1) {
						...
						t_ptr.identify |= Constants.ID_SHOW_HITDAM;
						t_ptr.tohit += 1 + Rnd.randomInt(3);
						t_ptr.plusToDam += 1 + Rnd.randomInt(3);
			...
			if (Misc1.isMagik(chance)) {
				...
				if (Misc1.isMagik(special)) {
					if (t_ptr.subCategory < 6) {
						...
						case 5:
							t_ptr.identify |= Constants.ID_SHOW_P1;
							t_ptr.misc = 5 * (1 + Rnd.randomInt(4));
		...
		case Constants.TV_LIGHT:
			if ((t_ptr.subCategory % 2) != 0) {
				t_ptr.misc = Rnd.randomInt(t_ptr.misc);
				t_ptr.subCategory -= 1;
			}
			break;
		...
		case Constants.TV_WAND:
			switch (t_ptr.subCategory) {
			case 0:	  t_ptr.misc = Rnd.randomInt(10) +	 6; break;
			case 1:	  t_ptr.misc = Rnd.randomInt(8)  +	 6; break;
			case 2:	  t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 3:	  t_ptr.misc = Rnd.randomInt(8)  +	 6; break;
			case 4:	  t_ptr.misc = Rnd.randomInt(4)  +	 3; break;
			case 5:	  t_ptr.misc = Rnd.randomInt(8)  +	 6; break;
			case 6:	  t_ptr.misc = Rnd.randomInt(20) +	 12; break;
			case 7:	  t_ptr.misc = Rnd.randomInt(20) +	 12; break;
			case 8:	  t_ptr.misc = Rnd.randomInt(10) +	 6; break;
			case 9:	  t_ptr.misc = Rnd.randomInt(12) +	 6; break;
			case 10:   t_ptr.misc = Rnd.randomInt(10) +	 12; break;
			case 11:   t_ptr.misc = Rnd.randomInt(3)  +	 3; break;
			case 12:   t_ptr.misc = Rnd.randomInt(8)  +	 6; break;
			case 13:   t_ptr.misc = Rnd.randomInt(10) +	 6; break;
			case 14:   t_ptr.misc = Rnd.randomInt(5)  +	 3; break;
			case 15:   t_ptr.misc = Rnd.randomInt(5)  +	 3; break;
			case 16:   t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 17:   t_ptr.misc = Rnd.randomInt(5)  +	 4; break;
			case 18:   t_ptr.misc = Rnd.randomInt(8)  +	 4; break;
			case 19:   t_ptr.misc = Rnd.randomInt(6)  +	 2; break;
			case 20:   t_ptr.misc = Rnd.randomInt(4)  +	 2; break;
			case 21:   t_ptr.misc = Rnd.randomInt(8)  +	 6; break;
			case 22:   t_ptr.misc = Rnd.randomInt(5)  +	 2; break;
			case 23:   t_ptr.misc = Rnd.randomInt(12) + 12; break;
			default:
				break;
			}
			break;
		...
		case Constants.TV_STAFF:
			switch (t_ptr.subCategory) {
			case 0:	  t_ptr.misc = Rnd.randomInt(20) +	 12; break;
			case 1:	  t_ptr.misc = Rnd.randomInt(8)  +	 6; break;
			case 2:	  t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 3:	  t_ptr.misc = Rnd.randomInt(20) +	 12; break;
			case 4:	  t_ptr.misc = Rnd.randomInt(15) +	 6; break;
			case 5:	  t_ptr.misc = Rnd.randomInt(4)  +	 5; break;
			case 6:	  t_ptr.misc = Rnd.randomInt(5)  +	 3; break;
			case 7:	  t_ptr.misc = Rnd.randomInt(3)  +	 1;
			t_ptr.level = 10;
			break;
			case 8:	  t_ptr.misc = Rnd.randomInt(3)  +	 1; break;
			case 9:	  t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 10:   t_ptr.misc = Rnd.randomInt(10) +	 12; break;
			case 11:   t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 12:   t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 13:   t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 14:   t_ptr.misc = Rnd.randomInt(10) +	 12; break;
			case 15:   t_ptr.misc = Rnd.randomInt(3)  +	 4; break;
			case 16:   t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 17:   t_ptr.misc = Rnd.randomInt(5)  +	 6; break;
			case 18:   t_ptr.misc = Rnd.randomInt(3)  +	 4; break;
			case 19:   t_ptr.misc = Rnd.randomInt(10) +	 12; break;
			case 20:   t_ptr.misc = Rnd.randomInt(3)  +	 4; break;
			case 21:   t_ptr.misc = Rnd.randomInt(3)  +	 4; break;
			case 22:   t_ptr.misc = Rnd.randomInt(10) + 6;
			t_ptr.level = 5;
			break;
			default:
				break;
