/*
 * SmallWoodenChest.java: item object
 * 
...
public class SmallWoodenChest extends TreasureType {
	public SmallWoodenChest() {
		this.name = "& Small Wooden Chest";
		this.flags = 0x13800000L;
