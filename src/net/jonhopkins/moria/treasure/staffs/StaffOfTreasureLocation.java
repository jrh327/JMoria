/*
 * StaffOfTreasureLocation.java: item object
 * 
...
public class StaffOfTreasureLocation extends TreasureType {
	public StaffOfTreasureLocation() {
		this.name = "Treasure Location";
		this.flags = 0x8L;
