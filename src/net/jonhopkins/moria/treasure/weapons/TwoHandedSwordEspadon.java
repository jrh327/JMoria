/*
 * TwoHandedSwordEspadon.java: item object
 * 
...
public class TwoHandedSwordEspadon extends TreasureType {
	public TwoHandedSwordEspadon() {
		this.name = "& Two-Handed Sword (Espadon)";
