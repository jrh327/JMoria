/*
 * ScrollOfMonsterConfusion.java: item object
 * 
...
public class ScrollOfMonsterConfusion extends TreasureType {
	public ScrollOfMonsterConfusion() {
		this.name = "Monster Confusion";
		this.flags = 0x400L;
