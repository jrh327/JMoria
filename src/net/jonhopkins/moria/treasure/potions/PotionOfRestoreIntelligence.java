/*
 * PotionOfRestoreIntelligence.java: item object
 * 
...
public class PotionOfRestoreIntelligence extends TreasureType {
	public PotionOfRestoreIntelligence() {
		this.name = "Restore Intelligence";
		this.flags = 0x20L;
