/*
 * ScrollOfObjectDetection2.java: item object
 * 
...
public class ScrollOfObjectDetection2 extends TreasureType {
	public ScrollOfObjectDetection2() {
		this.name = "Object Detection";
		this.flags = 0x8000L;
