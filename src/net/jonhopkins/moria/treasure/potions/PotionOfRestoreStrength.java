/*
 * PotionOfRestoreStrength.java: item object
 * 
...
public class PotionOfRestoreStrength extends TreasureType {
	public PotionOfRestoreStrength() {
		this.name = "Restore Strength";
		this.flags = 0x4L;
