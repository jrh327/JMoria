/*
 * ThrustingSwordBilbo.java: item object
 * 
...
public class ThrustingSwordBilbo extends TreasureType {
	public ThrustingSwordBilbo() {
		this.name = "& Thrusting Sword (Bilbo)";
