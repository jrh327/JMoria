/*
 * ScrollOfRuneOfProtection.java: item object
 * 
...
public class ScrollOfRuneOfProtection extends TreasureType {
	public ScrollOfRuneOfProtection() {
		this.name = "Rune of Protection";
		this.flags = 0x2000L;
