/*
 * ScrollOfDoorCreation.java: item object
 * 
...
public class ScrollOfDoorCreation extends TreasureType {
	public ScrollOfDoorCreation() {
		this.name = "Door Creation";
		this.flags = 0x800000L;
