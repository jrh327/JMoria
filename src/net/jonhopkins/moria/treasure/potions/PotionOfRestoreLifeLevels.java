/*
 * PotionOfRestoreLifeLevels.java: item object
 * 
...
public class PotionOfRestoreLifeLevels extends TreasureType {
	public PotionOfRestoreLifeLevels() {
		this.name = "Restore Life Levels";
		this.flags = 0x80L;
